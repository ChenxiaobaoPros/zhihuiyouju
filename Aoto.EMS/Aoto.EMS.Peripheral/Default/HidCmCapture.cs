...
namespace Aoto.EMS.Peripheral
{
    public class HidCmCapture
    {
        ...
        private IntPtr CanvasIntPtr;

        public HidCmCapture(IntPtr canvasIntPtr)
        {
            CanvasIntPtr = canvasIntPtr;
            IntPtr = Win32ApiInvoker.LoadLibrary(Path.Combine(Application.StartupPath, "CmCapture.dll"));
            ...
            int flag_camOpenDev = open(CamNo, 0, 0, 0);
            ...
            int flag_camSetPreviewWindow = set(CamNo, CanvasIntPtr);
        ...
        public void Photograph()
        {
            ...
            int flag_camCaptureImageFile = image(CamNo, PicPath);       //返回值6，参数错误
        ...
        {
            int flag_camCloseDev = close(CamNo);
